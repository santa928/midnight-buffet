...
interface OfflineBanquetProps {
  shuffle?: DishShuffler;
  onExit: () => void;
}

/** Coordinates the single-device banquet without exposing private selections. */
export function OfflineBanquet({ shuffle, onExit }: OfflineBanquetProps): ReactElement {
