...
const dishCatalog = new Map<number, DishPresentation>([
  ...
  [-1, trouble(-1, "塩を忘れたスープ", "少し困る置き土産")],
  [-2, trouble(-2, "焦げ目だらけのキッシュ", "香ばしさが行き過ぎた皿")],
  [-3, trouble(-3, "激辛ルージュパスタ", "湯気だけで涙が出る")],
  [-4, trouble(-4, "黒焦げグラタン", "会場が静まり返る問題作")],
  [-5, trouble(-5, "宴会長の罰ゲーム皿", "最後まで語り継がれる災難")],
]);
