...
- Create: `docs/design/assets/midnight-buffet-mobile-reference.png`
...
実装用 UI の文字は後で HTML で配置するため、画像内の可変文字に依存しない。次の意図で `390x844 portrait mobile` のゲーム選択画面を生成し、出力を `docs/design/assets/midnight-buffet-mobile-reference.png` に配置する。
...
```text
docs/design/assets/midnight-buffet-mobile-reference.png
